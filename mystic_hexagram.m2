...
-- Is determinant 0?
-- Also, I don't think that det = 0 is sufficient for concluding that there
-- something in the null space.  For example, if one has a zero adjunct.
-- So check that at least one minor is non-zero.
