-- 'Tangent' proof of Morley's theorem
-- I'll note that this also establishes eight other equilateral
-- triangles.
...
-- Must have a1n/a1d = tan(60)
<< a1n^2 - 3*a1d^2 == 0 and a2n^2 - 3*a2d^2 == 0 << endl
